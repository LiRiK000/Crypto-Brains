...
import styles from "./TsComp.module.css";
        ...
        <div className={styles.wrapper}>
            <div className={styles.content}>
                <div className={styles.textBlock}>
                    <h1 className={styles.title}>Technical Support</h1>
                    ...
                    <p className={styles.text} style={{
                        ...
                        1. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s <br/>
                        2. When an unknown printer took a galley of type and scrambled it to make a type specimen
                        book. <br/>
                        3. Lorem Ipsum is simply dummy text of the printing and typesetting industry. <br/>
                        4. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s <br/>
                        5. When an unknown printer took a galley of type and scrambled it to make a type specimen book.
                    </p>
