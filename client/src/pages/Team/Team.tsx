...
const ManagementDeportment = [require('../../components/TeamPageComp/Team/img/1.png'), require('../../components/TeamPageComp/Team/img/2.png'), require('../../components/TeamPageComp/Team/img/3.png'), require('../../components/TeamPageComp/Team/img/4.png')];
